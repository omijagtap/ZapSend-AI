...
import { Loader2, LogIn, Shield, HelpCircle, ExternalLink, Mail, Zap, BarChart3, CheckCircle2, Sparkles, Users, ChevronDown, Eye, EyeOff } from 'lucide-react';
  ...
  const handleLogin = async () => {
    if (!email || !password) {
      toast({
        ...
        description: 'Please enter both your Email and App Password.',
      });
      return;
    }
            ...
            >
              <Card className="glass-effect">
                <CardHeader className="text-center pb-3">
                  <CardTitle className="text-2xl font-headline">Welcome to ZapSend AI</CardTitle>
                  <CardDescription className="text-sm">Sign in with your email credentials to get started</CardDescription>
                </CardHeader>
                <CardContent className="pb-3">
                  <div className="space-y-3">
                    ...
                    <Button onClick={handleLogin} disabled={isLoading} className="w-full h-11 text-base font-semibold">
                ...
                <CardFooter className="pt-0 pb-3">
                  <div className="w-full space-y-2">
                    <div className="flex items-center justify-center text-xs text-muted-foreground gap-2">
                      ...
                      <span>Your credentials are secure and only used for verification</span>
                    </div>

                    {/* Help Dialog Trigger */}
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button variant="link" size="sm" className="text-sm text-primary h-auto p-0 hover:underline">
              ...
              <div className="space-y-4">
                <div>
                  <h1 className="text-4xl font-bold font-headline mb-3">
                    <span className="text-primary">Smart Email Campaigns,</span>
                    <br />
                    <span className="text-foreground">Made Simple.</span>
                  </h1>
                  <p className="text-muted-foreground text-base leading-relaxed">
                    Send personalized bulk emails with AI-powered optimization and comprehensive analytics.
                  </p>
                </div>

                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20 hover:bg-primary/10 transition-colors">
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      <Zap className="h-5 w-5 text-primary" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-sm mb-1">AI-Powered Subject Lines</h3>
                      <p className="text-xs text-muted-foreground">Boost open rates with smart optimization</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20 hover:bg-primary/10 transition-colors">
                    ...
                    <div>
                      <h3 className="font-semibold text-sm mb-1">Personalized Campaigns</h3>
                      <p className="text-xs text-muted-foreground">Dynamic content for each recipient</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20 hover:bg-primary/10 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Track performance and success rates</p>
                    </div>
                  </div>
                </div>
              </div>
